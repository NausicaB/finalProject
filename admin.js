...
function editItem(idx) {
    ...
    document.querySelector('.add > h4').innerText = 'Edit item ' + items.list[idx]['productName'];
    document.querySelector('[name="image"]').value =  items.list[idx]['url'];
    document.querySelector('[name="name"]').value =  items.list[idx]['productName'];
    document.querySelector('[name="description"]').innerHTML =  items.list[idx]['description'];
    document.querySelector('[name="price"]').value =  items.list[idx]['price'];
    document.querySelector('[name="stock"]').value =  items.list[idx]['stock'];
...
async function saveChanges() {
    ...
    if (state.editIdx !== null) {
        ...
        // let existingItems = await response1.json();
